...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 4 - Le chemin d'un heros", "'Un vieil ami se bat a la frontiere sud pour repousser les assaillants, je pense que vous etes prets a en savoir plus.'\nAller a la rencontre du moine au sud.", 5, "0", 0, "moine"));
        quetes.add(new KillQuete("Chapitre 4 - Le chemin d'un heros", "'Vite heros, tuez les deux yeux a l'entree de l'avant poste !!'\nTuer 2 yeux vivants.", 10, "", 0, "Oeil", 2));
        quetes.add(new TalkQuete("Chapitre 4 - Le chemin d'un heros", "Retourner voir le moine.", 50, "Potion", 1, "moine"));
        quetes.add(new LootQuete("Chapitre 4 - Le chemin d'un heros", "'C'est le maitre du Dojo qui vous envoie je suppose, vous savez vous battre ca se voit. Les defenses commencent a faiblir vous allez m'aider a reconstruir ces barricades. J'ai quelque chose pour vous si vous m'aidez.'\nCouper 4 buches de bois.", 15, "", 0, "SourceBois", 4));
        quetes.add(new TalkQuete("Chapitre 4 - Le chemin d'un heros", "Retourner voir le moine.", 50, "Shuriken", 1, "moine"));
        quetes.add(new KillQuete("Chapitre 4 - Le chemin d'un heros", "'Vous semblez honnete héros, je sens que vous etes quelqu'un de confiance. Prenez ces shurikens, si c'est le livre que vous cherchez, il va falloir se battre.'\nTuer 3 betes.", 10, "", 0, "Bete", 3));
        ...
        quetes.add(new TalkQuete("Chapitre 4 - Le chemin d'un heros", "'Vous les avez tue ? Parfait, j'ai reussi a renforcer les barricades. Continuez d'explorer le marais, vous trouverez surement quelque chose au sud !'\nExplorer le sud du marais et trouver des informations.", 10, "", 0, "goldninja"));
        ...
        quetes.add(new TalkQuete("Chapitre 4 - Le chemin d'un heros", "'Je n'arrive pas a y croire ! Vous l'avez !! Vous avez le livre de Momoku je le sens ! Il faut prevenir le maitre du Dojo de suite !!!'\nRetourner voir le maitre du Dojo.", 30, "Niveau", 1, "master"));

        quetes.add(new TalkQuete("Chapitre 5 - Hallucination collective", "'Vous l'avez... Vous l'avez obtenu heros, laissez moi le toucher.'\n*Le maitre passe son doigt sur le livre...*\n'La naissance du monde a ete prive d'un sens primordial !? Comment est-ce possible !?'\nDiscuter avec le maitre.", 30, "", 0, "master"));
        quetes.add(new TalkQuete("Chapitre 5 - Hallucination collective", "'J'ai toujours su que quelque chose n'allais pas, il nous manque quelque chose. Quelque chose de tres important. Tout ca a surement un rapport avec les hallucinations a l'ouest vous devriez y jeter un coup d'oeil.'\nSe rendre a l'ouest et enqueter.", 30, "", 0, "cavegirl"));
        quetes.add(new TalkQuete("Chapitre 5 - Hallucination collective", "Discuter avec la fille aux cheveux sales.", 30, "", 0, "cavegirl"));
        quetes.add(new KillQuete("Chapitre 5 - Hallucination collective", "'J'aurai jamais cru demander de l'aide a quelqu'un de moche comme vous, mais je n'ai pas le choix... Les bambous commencent a envahir mon espace vital !'\nTuer 2 bambous vivants.", 10, "", 0, "Bambou", 2));
        quetes.add(new KillQuete("Chapitre 5 - Hallucination collective", "'Qu'est ce que c'est que ce monument ? Personne n'a remarque ca ? Je vais tenter de degager la zone et d'en parler a la fille.'\nTuer 2 reptiles.", 10, "", 0, "Reptile", 2));
        ...
        quetes.add(new TalkQuete("Chapitre 5 - Hallucination collective", "'Un monument a l'ouest ? Mais oui biensur ! Seul le proprietaire du livre de Momoku ressent ce qu'autrui ignore! Vous etes l'elu !!'\nDiscuter avec le maitre du dojo.", 30, "", 0, "master"));
        ...
        quetes.add(new TalkQuete("Chapitre 5 - Hallucination collective", "'Heros, vous avez sauve ce monde du cauchemar. L'humanite a retrouve ce qu'on lui a vole. La vision. Vous avez redonne vie a ce monde. Merci.'\nRemercier le spectre.", 1000, "Niveau", 1, "spectre"));
    }
