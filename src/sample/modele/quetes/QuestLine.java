...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 5 - Le secret", "'Vous l'avez... Vous l'avez obtenu heros, laissez moi le toucher.'\n*Le maitre passe son doigt sur le livre...*\n'La naissance du monde a ete prive d'un sens primordial !? Comment est-ce possible !?'\nDiscuter avec le maitre.", 30, "", 0, "master"));
        quetes.add(new TalkQuete("Chapitre 5 - Le secret", "'J'ai toujours su que quelque chose n'allais pas, il nous manque quelque chose. Quelque chose de tres important. Tout ca a surement un rapport avec le monument a l'ouest vous devriez y jeter un coup d'oeil.'\nSe rendre a l'ouest et enqueter.", 30, "", 0, "cavegirl"));
    }
